...
<div class="mx-auto max-w-2xl">
    <div class="bg-surface-light dark:bg-surface-dark p-8 rounded-2xl border border-border-light dark:border-border-dark shadow-glass-sm">
        <h2 class="text-2xl font-bold text-text-primary-light dark:text-text-primary-dark mb-8">Tambah Pasien Baru</h2>
        <form action="{{ route('patients.store') }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 gap-6">
                <div>
                    <x-input-label for="nik" value="NIK" />
                    <x-text-input type="text" name="nik" value="{{ old('nik') }}" maxlength="16" required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-text-input type="date" name="date_of_birth" value="{{ old('date_of_birth') }}" required />
