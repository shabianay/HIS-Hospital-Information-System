...
<div class="space-y-6">
    ...
    <div class="bg-surface-light dark:bg-surface-dark p-8 rounded-2xl border border-border-light dark:border-border-dark shadow-glass-sm">
        <form method="GET" action="{{ route('radiology.requests') }}" class="mb-6 flex flex-col sm:flex-row gap-3">
        ...
        <x-table placeholder="Cari pasien / no. antrian...">
            ...
            <tr data-search-row x-show="!search || $el.textContent.toLowerCase().includes(search.toLowerCase())" class="border-b border-border-light dark:border-border-dark hover:bg-primary-50/50 dark:hover:bg-primary-900/10 transition-colors">
                ...
                <td class="py-4 px-4">
                    <a href="{{ route('radiology.requests.show', $req) }}" class="text-sm font-semibold text-primary-600 hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300">Proses</a>
                </td>
            </tr>
            @empty
