...
@section('content')
<div class="mx-auto max-w-4xl" x-data="{ consultation: {{ $consultationFee }}, medicineTotal: {{ $totalPrescription }}, actionTotal: 0, discount: 0, get total() { return Math.max(0, parseFloat(this.consultation || 0) + parseFloat(this.medicineTotal || 0) + parseFloat(this.actionTotal || 0) - parseFloat(this.discount || 0)); } }">
